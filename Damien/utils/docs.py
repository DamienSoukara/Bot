...
BANNED = "https://i.imgur.com/zDbjjQw.jpg"
...
BAN = (
    f"{emoji.ROBOT} **SixPathsOfPain Assistant**\n\n"
    f"`HAHAHA` – RESPECT RULES BRO\n"
    f"`Join My Channel` – @DamienSoukara\n\n")
...
BAN_RESULTS = [
    InlineQueryResultArticle(
        title="You're Banned",
        input_message_content=InputTextMessageContent(BAN, disable_web_page_preview=True, parse_mode="markdown"),
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
                f"{emoji.FIRE} Feedback ",
                url="t.me/DamienRobot"
            ),
            InlineKeyboardButton(
                f"{emoji.FIRE} Go!",
                switch_inline_query=""
        ...
        description="Do You Wanna Know Why ?",
        thumb_url=BANNED,
    ),
]
